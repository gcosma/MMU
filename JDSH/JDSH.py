...
from utils import compress, calculate_top_map, logger, calculate_top_map_classes
...
class JDSH:
    ...
    def eval(self):
        ...
        '''
        print('Image to text:')
        calculate_top_map_classes(qu_B=qu_BI, re_B=re_BT, qu_L=qu_L, re_L=re_L, topk=1)
        print('Text to image:')
        calculate_top_map_classes(qu_B=qu_BT, re_B=re_BI, qu_L=qu_L, re_L=re_L, topk=1)
        '''
        #''''
        MAP_I2T = calculate_top_map(qu_B=qu_BI, re_B=re_BT, qu_L=qu_L, re_L=re_L, topk=None)
        MAP_T2I = calculate_top_map(qu_B=qu_BT, re_B=re_BI, qu_L=qu_L, re_L=re_L, topk=None)
        k1MAP_I2T = calculate_top_map(qu_B=qu_BI, re_B=re_BT, qu_L=qu_L, re_L=re_L, topk=1)
        k1MAP_T2I = calculate_top_map(qu_B=qu_BT, re_B=re_BI, qu_L=qu_L, re_L=re_L, topk=1)
        k5MAP_I2T = calculate_top_map(qu_B=qu_BI, re_B=re_BT, qu_L=qu_L, re_L=re_L, topk=5)
        k5MAP_T2I = calculate_top_map(qu_B=qu_BT, re_B=re_BI, qu_L=qu_L, re_L=re_L, topk=5)
        k10MAP_I2T = calculate_top_map(qu_B=qu_BI, re_B=re_BT, qu_L=qu_L, re_L=re_L, topk=10)
        k10MAP_T2I = calculate_top_map(qu_B=qu_BT, re_B=re_BI, qu_L=qu_L, re_L=re_L, topk=10)
        ...
        self.logger.info('mAP@1 I->T: %.3f, mAP@50 T->I: %.3f' % (k1MAP_I2T, k1MAP_T2I))
        self.logger.info('mAP@5 I->T: %.3f, mAP@50 T->I: %.3f' % (k5MAP_I2T, k5MAP_T2I))
        self.logger.info('mAP@10 I->T: %.3f, mAP@10 T->I: %.3f' % (k10MAP_I2T, k10MAP_T2I))
