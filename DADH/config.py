...
class Default(object):
    ...
    def data(self, flag):
        ...
        if flag == 'nus':
            ...
            self.text_dim = 1000
            self.training_size = 10000
        if flag == 'mir_unpaired':
            self.dataset = 'flickr25kunpaired80balanced'
            self.data_path = './data/FLICKR-25K.mat'
            self.db_size = 18015
            self.num_label = 24
            self.query_size = 2000
            self.text_dim = 1387
            self.training_size = 10000
        if flag == 'mir_unpaired_image':
            self.dataset = 'flickr25kunpairedimageall'
            self.data_path = './data/FLICKR-25K.mat'
            self.db_size = 18015
            self.num_label = 24
            self.query_size = 2000
            self.text_dim = 1386
            self.training_size = 10000
        if flag == 'nus_unpaired':
            self.dataset = 'nus-unpaired50'
            self.data_path = './data/NUS-WIDE-TC21.mat'
            self.db_size = 193734
            self.num_label = 21
            self.query_size = 2100
